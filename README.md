...
- **Tour**: the very first start walks you through the window in five tips: search, favorites, the zapper and the compact window. Double-click the version number in the settings to see it again.
