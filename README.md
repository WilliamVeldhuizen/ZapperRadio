...
- **Settings** (a tab next to the others): start with Windows, language, per-favorite loudness, station list info and update check, clearing the logo and popularity cache, checking for a new version of the app, and the app version.
