...
- **Settings** (the gear): language, app version, checking for a new version of the app, station list info and update check, shortcuts, the length of the time-shift buffer, per-favorite loudness, and clearing the logo and popularity cache.
